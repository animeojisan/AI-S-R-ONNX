...
public:
    ...
    bool RunPixels(const PIXEL_RGBA* src_pixels, int width, int height, std::vector<PIXEL_RGBA>& dst_pixels,
        ...
        auto result = session_.Evaluate(cached_binding_, L"AI_Super_Resolution_ONNX");
...
#define PLUGIN_NAME      L"AI Super-Resolution ONNX"
...
EXTERN_C __declspec(dllexport) bool InitializePlugin(DWORD) {
    DebugOut(L"AI Super-Resolution ONNX InitializePlugin");
    UpdateBackendLabels();
...
EXTERN_C __declspec(dllexport) void UninitializePlugin() {
    DebugOut(L"AI Super-Resolution ONNX UninitializePlugin");
