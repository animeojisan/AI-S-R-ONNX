...
[![AI S-R ONNX紹介動画](docs/images/AI_S-R_ONNX_01.jpg)](https://youtu.be/_OrCfafRG5g)

## :computer:動作環境
- Windows環境
- AviUtl2 （ExEdit2 beta40にて動作確認）
- ONNXモデルファイル
- GPUまたはCPUでの推論実行環境
...
1. `AI_S-R_ONNX.auf2` を AviUtl2 の `Plugin` フォルダに入れます
2. AviUtl2 を起動します
...
- 対応モデルは float32 / float16 の 1入力1出力・4次元 NCHW 形式です。単一画像を入力する SISR モデルと、複数フレームを入力する VSR モデルに対応しています
...
- [Phhofm](https://github.com/Phhofm/models)
